...
//   textMuted: "#64748b", // grayish muted
//   border: "#d1fae5", // subtle greenish border
...
//   shadow: "#000000",
//   gradients: {
//     background: ["#f0fdf4", "#dcfce7"], // soft green wash
//     surface: ["#ffffff", "#f8fafc"],
//     primary: ["#25D366", "#20B954"], // WhatsApp green gradient
//     success: ["#34d399", "#059669"], // emerald → darker green
//     warning: ["#f59e0b", "#d97706"],
//     danger: ["#ef4444", "#dc2626"],
//     muted: ["#9ca3af", "#6b7280"], // gray tones
//     empty: ["#f3f4f6", "#e5e7eb"],
//   },
//   backgrounds: {
//     input: "#ffffff",
